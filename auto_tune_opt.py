...
def parse_opt():
    ...
    parser.add_argument(
        '--input_json',
        type=str,
        default='D:\\PycharmProjects\\video_relation_detection\\data\\5242_data\\val_info.json',
        help='path to the json file containing video info')
    parser.add_argument(
        '--info_json',
        type=str,
        default='D:\\PycharmProjects\\video_relation_detection\\data\\5242_data\\info.json',
        help='path to the json file containing additional info and vocab')
    parser.add_argument(
        '--caption_json',
        type=str,
        default='D:\\PycharmProjects\\video_relation_detection\\data\\5242_data\\train_val_label.json',
    ...
    parser.add_argument(
        ...
        nargs='*',
        type=str,
        default=['D:\\PycharmProjects\\video_relation_detection\\data\\feats\\resnet152/'],
        help='path to the directory containing the preprocessed fc feats')

    parser.add_argument('--c3d_feats_dir', type=str,
                        default='D:\\PycharmProjects\\video_relation_detection\\data\\feats\\conv3d_feats')
    parser.add_argument(

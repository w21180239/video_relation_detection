...
def parse_opt():
    ...
    parser.add_argument(
        '--input_json',
        type=str,
        default='data/5242_data/val_info.json',
        help='path to the json file containing video info')
    parser.add_argument(
        '--info_json',
        type=str,
        default='data/5242_data/info.json',
        help='path to the json file containing additional info and vocab')
    parser.add_argument(
        '--caption_json',
        type=str,
        default='data/5242_data/train_val_label.json',
    ...
    parser.add_argument(
        '--epochs', type=int, default=46, help='number of epochs')
    parser.add_argument(
